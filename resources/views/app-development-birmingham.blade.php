		...
		<div class="row">
			...
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					<img src="images/locations/birmingham/birmingham.webp" alt="Birmingham" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 block-1 wow fadeIn">
				<img src="images/locations/birmingham/scale-your-business.webp" alt="Scale Your Business" class="img-fluid" width="1005" height="100%">
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-12">
				<div class="common-heading w-tdxt text-center">
					<div data-text="Awards" class="dark-bg-text bg-text text-center">
						...
						<p class="text-white">AppsNation is Birmingham's top mobile app development company, providing quick, innovative, and dependable app solutions that propel business expansion.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row wow fadeIn">
			<div class="col-lg-6 my-auto">
				<div class="common-heading">
					<div data-text="Developers" class="dark-bg-text bg-text">
						<h2><span>Expand Your Market Presence with Our Top Mobile App </span>Development Company in Birmingham</h2>
					</div>
					<p class="pt-2">We are the No.1 mobile app development company in Birmingham that offer impeccable solutions under cost-effective rates. We build high-quality, user-friendly mobile apps that drive growth and help you reach more customers & generate massive revenue. With our award-winning solutions and industry expertise, we help you in keeping ahead of your rivals.</p>
					<a href="{{url('/contact-us')}}" class="niwax-btn button-arounder btn wow fadeIn mt-3 py-2 px-3" data-wow-delay="0.8s">Get Consultation <i class="fas fa-chevron-right fa-ani"></i></a>
				</div>
			</div>
