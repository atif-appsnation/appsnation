		...
		<div class="row">
			...
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					<img src="images/locations/washington/washington.webp" alt="Washington" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 block-1 wow fadeIn">
				<img src="images/locations/washington/scale-your-business.webp" alt="Scale Your Business" class="img-fluid" width="100%" height="100%">
			</div>
		</div>
	</div>
</section>
