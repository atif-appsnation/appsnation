...
<section class="breadcrumb-areav2 social-media-marketing-banner services-banner">
...
<!-- Start Services -->
<section class="case-study-section fix py-5">
	</div>
	<div class="container">
		<div class="section-title-area">
			<div class="section-title">
				...
				<h2 class="wow fadeIn">Social Media Marketing Services </h2>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-xxl-6 wow fadeIn">
					<div class="case-study-box-items">
						<div class="thumb">
							<img src="images/services/social-media-marketing/seo.webp" alt="img" loading="lazy">
							<div class="post-box-items">
								<ul>
									<li>
										<a>Instagram Marketing Services </a>
									</li>
									<li>
										<a>TikTok Marketing Services </a>
									</li>
								</ul>
								<ul>
									<li>
										<a>LinkedIn Marketing Services </a>
									</li>
									<li>
										<a>Facebook Marketing Services </a>
									</li>
								</ul>
							</div>
							<h3 class="project-title">
								<a>
									<img src="images/services/social-media-marketing/icon.png" alt="img" loading="lazy">Social Media Marketing
								</a>
							</h3>
				...
				<div class="col-xxl-6">
					<div class="main-box">
						...
						<div class="box bg-1 wow fadeIn wow" data-wow-delay=".2s">
							<div class="title-items">
								<h3>
							...
							<div class="project-content">
								<h3>TikTok Marketing Services</h3>
								<p>TikTok is another platform to give a boost to your online presence. It is all about creating and sharing short videos that are trending all</p>
							</div>
						</div>
						<div class="box bg-2 wow fadeIn wow" data-wow-delay=".4s">
							<div class="title-items">
								<h3>
							...
							<div class="project-content">
								...
								<p>LinkedIn helps you market your products and services to potential target audiences and also helps you</p>
							</div>
						</div>
						<div class="box bg-3 wow fadeIn wow" data-wow-delay=".6s">
							<div class="title-items">
								<h3>
							...
							<div class="project-content">
								...
								<p>Facebook is a public social media platform that acts as an access point for you and your target audience.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="d-flex justify-content-center gap-4 wow fadeIn mt-4" data-wow-delay=".7s">
			...
			<div class="banner-box-image market-growth-banner">
				<div class="h-100 align-items-center row">
					<div class="col-xxl-5 col-xl-6 col-lg-6 col-md-8 col-12 common-heading">
						<h2>Market Growth <span>(Search Engine Optimization)</span> </h2>
			...
			<div class="banner-box-image social-media-platforms-banner">
				<div class="h-100 align-items-center row">
					<div class="col-xxl-5 col-xl-6 col-lg-6 col-md-8 col-12">
						<h2><span>Popular Social Media Platforms</span></h2>
						<p>Engage your audience with high-quality content marketing that builds trust, strengthens brand authority, improves SEO performance, and drives meaningful customer engagement and conversions.</p>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="common-heading ptag wow fadeIn">
					<div data-text="Succeed" class="light-bg-text bg-text mt-5">
						<h2>Social Media Marketing Road Map: How We <span>Help You Succeed</span> </h2>
					</div>
				</div>
			</div>
		</div>
		<div class="row upset justify-content-center mt30">
			<div class="col-12 col-md-6 col-lg-4">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Set Clear Goals</h3>
					<p class="description">We collaborate with you to define specific objectives, and set clear goals, whether it involves increasing brand awareness, generating leads, or boosting sales. Establishing clear goals ensures that every effort is fully aligned with your business vision.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">02</p>
					<h3 class="title">Research your Target Audience</h3>
					<p class="description">We dive deep into understanding your ideal customers—their demographics, interests, and online behaviors—so we can carefully tailor a strategy that speaks directly to them.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-lg-0">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">03</p>
					<h3 class="title">Determine Social Media Platforms Aligned with Your Brand</h3>
					<p class="description">Our team identifies the social media platforms that align with your brand and audience. We ensure your business is visible where it matters the most, ensuring your message reaches to the right people through the right medium.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">04</p>
					<h3 class="title">Set Metrics and KPIs </h3>
					<p class="description">As a competent social media management company, we set benchmarks that are easily measurable like engagement rates, follower growth, and conversions. These KPIs help us track success and adjust real-time strategies to maximize your ROI.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					...
					<p class="description">We craft compelling content that captures your brand’s identity and also resounds with your audience. Our team ensures a mix of visuals, videos, and posts that drive interaction with a loyal community.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">06</p>
					<h3 class="title">Schedule Posts on Social Media </h3>
					<p class="description">We handle the scheduling of your content, making sure it’s posted at optimal times to maximize reach and engagement. Our goal is to keep reminding your audiences about your brand at regular intervals.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row upset justify-content-center mt30">
			<div class="col-12 col-md-6 col-lg-4">
				<div class="timeline wow fadeIn h-100">
					<div class="timeline-year">
						<img src="images/services/social-media-marketing/certified-professionals.svg" alt="Certified Professionals" class="img-fluid" width="100%" height="100%" loading="lazy">
					</div>
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
				<div class="timeline wow fadeIn h-100">
					<div class="timeline-year">
						<img src="images/services/social-media-marketing/best-marketing-packages.svg" alt="Best Marketing Packages" class="img-fluid" width="100%" height="100%" loading="lazy">
					</div>
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-lg-0">
				<div class="timeline wow fadeIn h-100">
					<div class="timeline-year">
						<img src="images/services/social-media-marketing/24x7-customer-support.svg" alt="24x7 Customer Support" class="img-fluid" width="100%" height="100%" loading="lazy">
					</div>
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<div class="timeline-year">
						<img src="images/services/social-media-marketing/free-consultation.svg" alt="Free Consultation" class="img-fluid" width="100%" height="100%" loading="lazy">
					</div>
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<div class="timeline-year">
						<img src="images/services/social-media-marketing/transparency.svg" alt="We Believe in Transparency" class="img-fluid" width="100%" height="100%" loading="lazy">
					</div>
	...
	<div class="container">
		<div class="section-title-area">
			<div class="section-title">
				...
				<h2 class="wow fadeIn" data-wow-delay=".3s">Digital Marketing Solutions for Every Industry</h2>
			</div>
		</div>
		<p class="mt-3 mt-md-0 wow fadeIn" data-wow-delay=".5s">At <b>AppsNation</b>, we help businesses of all sizes and sectors grow online. From startups to established brands, our <b>AI-driven digital marketing services</b> deliver results across multiple industries.</p>
		<div class="industries wow fadeIn mt-4" data-wow-delay="0.7s">
			<div class="row ">
